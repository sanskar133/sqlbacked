...
class Sqlite3(Database):
    display_name: str = "Sqlite3"
    description: str = "Connect Your Sqlite3 Database"
    ...
    def has_valid_credentials(self) -> bool:
        logger.info("Checking if the user has valid Postgres Credential")
        try:
            connection_params = {
                field.field_name: self.connection_details[field.field_name]
                for field in self.field_config
            }
            with sqlite3.connect(**connection_params):
                return True

        except sqlite3.Error:
            logger.error("Error in connecting postgres database", exc_info=True)
            return False
    ...
    def database_schema(self):
        ...
        try:
            ...
            with sqlite3.connect(**connection_params) as connection:
    ...
    def get_engine(self):
        ...
        try:
            ...
            self.database_engine = sqlite3.connect(**connection_params)
            return True
